...
# Phase 2B bench-testing gate — see .env.example. Real firmware writing
# requires this flag AND the two above, all three true at once.
ARG VITE_ENABLE_HARDWARE_VALIDATION_MODE=false
ENV VITE_ENABLE_HARDWARE_VALIDATION_MODE=${VITE_ENABLE_HARDWARE_VALIDATION_MODE}
